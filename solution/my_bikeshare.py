...
CITY_DATA = {'chicago': 'csv_files/chicago.csv',
             'new york city': 'csv_files/new_york_city.csv',
             'washington': 'csv_files/washington.csv'}
...
def get_filter():
    ...
    while True:
        ...
        choosen_num = str(input("Enter your choice:: "))
